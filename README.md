...
- **Example**: If you want a total supply of 1,000,000 tokens with 18 decimals, the value should be `10000000000000000000000`.

```typescript
const maxSupply: u256 = u129.fromString('1000000000000000000000000').toU256(); // 1,000,000 tokens with 18 decimals
```
...
```typescript
const name: string = 'DIECHMANN'; // e.g., 'DIECHMANN'
```
...
```typescript
const symbol: string = 'DIECH'; // e.g., 'DIECH'
```
...
```typescript
const maxSupply: u256 = u129.fromString('1000000000000000000000000').toU256(); // Your max supply
const decimals: u8 = 18; // Your decimals
const name: string = 'DIECHMANN'; // DIECHMANN
const symbol: string = 'DIECH'; // DIECH
```
